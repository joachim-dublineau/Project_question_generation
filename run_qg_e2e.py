...
wandb.login()
wandb.init(project="question_generation_french", name = "t5-fr-e2e-mix_2")
...
def main(args_file=None):
    ...
    # Set project name
    os.environ["WANDB_PROJECT"] = "question_generation_french"
    ...
    if training_args.do_train:
        ...
        save_model_dir = os.path.join(training_args.output_dir, 'checkpoint-last')
